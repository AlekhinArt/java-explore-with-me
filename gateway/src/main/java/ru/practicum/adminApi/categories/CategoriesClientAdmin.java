...
@Service
public class CategoriesClientAdmin extends BaseClient {
    @Autowired
    public CategoriesClientAdmin(@Value("${main-service-server.url}") String serverUrl, RestTemplateBuilder builder) {
        super(
                builder
